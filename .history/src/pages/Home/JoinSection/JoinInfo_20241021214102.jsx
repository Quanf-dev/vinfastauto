  ...
  return (
    <div className="relative h-[1084px] w-full text-colors-bgColor">
      <div className="absolute z-20 w-full flex flex-col items-center justify-center h-[684px] gap-7">
        ...
        <Input
          className="max-w-[700px] border-l-0 border-r-0 border-t-0 rounded-none hover:border-r-0 hover:border-t-0 hover:rounded-none"
          type="email"
          placeholder="Email"
        />
        <div className="flex">
          <p className="max-w-[530px] text-[0.938rem] font-thin">
