...
export default function ContentJoin() {
  return (
    <div className=" bg-black h-[10000px] text-colors-bgColor relative">
      <div className="z-20 h-[136px] bg-custom-gradient">
      ...
      <div className="h-[648px]  bg-custom-gradient absolute top-60">
