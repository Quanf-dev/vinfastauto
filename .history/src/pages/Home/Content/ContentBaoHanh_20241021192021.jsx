...
export default function ContentBaoHanh() {
  return (
    <div className=" relative w-full h-[900px]">
      <div className="absolute left-[38px] z-10 flex flex-col justify-center gap-16 h-full">
        <div>
        ...
        {/* *********** */}
        <div>
          <h3 className="text-[1.625rem] mb-5">Chính sách bảo hành</h3>
        ...
        <div>
          ...
          <p>Bảo hành vượt trội lên đến 10 năm.</p>
          <Button size="lg" className="mt-5 shadow-customButton">
            <span>Đặt lịch</span>
          </Button>
        </div>
      </div>
