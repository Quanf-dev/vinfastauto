  ...
  return (
    <div className="h-[500px]">
      ...
      <div className="flex">
        <div>
          <img
            src="images\Home\Section\Content\carr.png"
            alt=""
            className="w-[535px] h-[670px] "
          />
          <h2>Pin và trạm sạc ô tô</h2>
        ...
        <div>
          <img
            src="images\Home\Section\Content\image260.png"
            alt=""
            className="w-[535px] h-[670px] "
          />
          <h2>Pin và trạm sạc xe máy</h2>
          <Button variant="outline">
            <span>Chi tiết</span>
          </Button>
        </div>
