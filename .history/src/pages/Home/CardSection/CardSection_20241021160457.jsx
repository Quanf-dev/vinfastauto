...
export default function CardSection() {
  return (
    <div className="h-[3800px] w-full px-10 flex-col flex gap-28  ">
      ...
      <div className="relative -top-14 flex-col flex items-center overflow-x-scroll snap-x snap-mandatory  content z-20  ">
        <div className="flex ">
          <Card DataCard={DataBike} />
        </div>
      </div>
      {/* rengtale cua scrollbar */}
      <div className="-top-[118.5px] left-1/2 z-10 -translate-x-1/2  w-[340px] h-[3px] bg-[#CBCBCB] relative"></div>
    </div>
  );
}
