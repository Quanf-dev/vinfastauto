...
export default function CardSection() {
  return (
    <div className="h-[1800px] w-full px-10 flex-col flex gap-28 overflow-x-scroll scrollbar-track-amber-400  scrollbar-thumb-neutral-950">
      ...
      <div className="flex-col flex items-center w-full  scrollbar-thumb-[#8E8E97]  ">
        ...
        <Carousel className="w-full overflow-x-scroll scrollbar-track-amber-400  scrollbar-thumb-neutral-950">
