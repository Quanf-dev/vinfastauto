...
export default function CardSection() {
  return (
    <div className="h-[3800px] w-full px-10 flex-col flex gap-28 ">
      ...
      <div className="flex-col flex items-center overflow-x-scroll snap-x snap-mandatory  content z-10  ">
        <div className="flex ">
          <Card DataCard={DataBike} />
          {/* rengtale cua scrollbar */}
        </div>
      </div>
      <div className="-top-[120px] left-1/2 z-10 -translate-x-1/2  w-[340px] h-[3px] bg-red-700 relative"></div>
    </div>
  );
}
