...
export default function CardSection() {
  return (
    <div className="h-[3800px] w-full px-10 flex-col flex gap-28 ">
      ...
      <div className="flex-col flex items-center overflow-x-scroll snap-x snap-mandatory  content relative  ">
        <div className="flex ">
          <Card DataCard={DataBike} />
          {/* rengtale cua scrollbar */}
          <div className="left-16 top-[400px] z-20 w-[440px] h-10 bg-red-700 absolute"></div>
        </div>
      </div>
    </div>
  );
