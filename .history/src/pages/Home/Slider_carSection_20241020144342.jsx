...
export default function Slider_car() {
  ...
  return (
    <div className=" relative h-[915px] w-full flex-col flex items-center gap-4">
      <img
      ...
      <div>
        <Carousel className="mt-40">
          ...
          <CarouselNext
            onClick={() => handleNext()}
            className="bg-[#8E8E9780] h-12 w-12  text-white rounded-full border-none"
          />
        </Carousel>
      </div>
      <div className="flex gap-5 ">
        ...
        <Button
          className="w-auto py-5 px-11 effect-custom effect-custom-outline   relative"
          variant="outline"
        >
          <span> Xem thêm</span>
        </Button>
