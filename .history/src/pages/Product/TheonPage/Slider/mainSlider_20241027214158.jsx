...
export default function MainSlider() {
  const infoBike = [
    { urlIcon: <GrDashboard />, title: "Tốc độ tối đa", text: "99km/h" },
    { urlIcon: "", title: "Độ rộng cốp xe", text: "99km/h" },
    { urlIcon: "", title: "Hệ thống phanh", text: "99km/h" },
    { urlIcon: "", title: "Quãng đường di chuyển", text: "99km/h" },
  ];
  return (
