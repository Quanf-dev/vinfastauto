  ...
  return (
    <div className="h-[1019px] w-full relative mx-10 ">
      ...
      <div className="absolute bottom-20">
        <h1 className="text-[2.5rem]">69.900.000 VNĐ</h1>
        <p className="text-[0.875rem] font-semibold relative bottom-1">
          (Giá đã bao gồm VAT, 01 bộ sạc và không bao gồm pin)
        </p>
        <Button className="w-[440px] py-7 mt-6">
