...
export default function Overview() {
  const Lists = [
    {
      title: "AN TOÀN",
      urlIcon: <MdOutlineSecurity size={24} className={className} />,
      desc: "Hệ thống phanh ABS tại cả bánh trước và sau. Đảm bảo an toàn trên mọi địa hình",
    },
    {
      title: "ĐỘNG CƠ",
      urlIcon: <MdEnergySavingsLeaf size={24} className={className} />,
      desc: "Động cơ điện đặt tại vị trí trung tâm. Công suất tối đa 7100W",
    },
    {
      title: "AN TOÀN",
      urlIcon: <CiCoins1 size={24} className={className} />,
        ...
        {Lists.map((item, index) => (
          <li key={index} className="flex flex-col items-center relative">
            ...
            <div className="flex relative">
              ...
              <Icon size={24} className="absolute bottom-4" />
            </div>
