    ...
    <ul className="flex -gap-10 w-full justify-center items-center">
      {Lists.map((item) => (
        <li
          ...
          key={item.id}
          className={`${active === item.id ? "w-[288.5px] scale-95 " : " custom-effect-scale"} transform-scale duration-300 ease-in  flex-shrink-0 -mr-12 clip-path-parallelogram w-[222.67px] `}
        >
