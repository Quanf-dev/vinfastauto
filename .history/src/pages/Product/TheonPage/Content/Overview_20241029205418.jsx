...
export default function Overview() {
  ...
  return (
    <div className="h-[811px] w-full relative mx-10">
      <ReactPlayer
        url="video\bike.mp4"
        playing={true}
        muted={true}
        ...
        height="auto"
      />
      <ul className="flex gap-24  absolute bottom-5 text-colors-bgColor ">
        {Lists.map((item, index) => {
          ...
          return (
            <li key={index} className="flex flex-col relative">
              ...
              <p className="max-w-[331px] absolute top-12 left-16 ">
                {item.desc}
              </p>
            </li>
          );
