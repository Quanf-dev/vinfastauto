...
export default function ItemCard(props) {
  return (
    <div className="flex w-[1440px] gap-5 snap-x snap-mandatory overflow-x-scroll">
      {props.DataCard.map((item) => (
        <div className=" relative w-[1440px] h-[452px] bg-gradient-to-b from-[#E9E9E9] to-transparent snap-start ">
