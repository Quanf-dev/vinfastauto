...
export default function ItemCard() {
  return (
    <div className="relative w-[440px] h-[552px] bg-gradient-to-b from-[#E9E9E9] to-transparent">
      {DataCard.map((item) => (
        <div className="absolute left-8 top-8 ">
          ...
          <div className="flex-col flex items-center ">
            ...
            <div className="flex gap-2 mt-6 shadow-custom">
              <Button size="sm" className="relative -left-3 w-[230px]">
