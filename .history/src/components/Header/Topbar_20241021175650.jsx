...
export default function Topbar() {
  ...
  return (
    <nav className="fixed top-0 bg-[#07070780] z-100 h-[72px] xxl:h-[90px] w-full backdrop-blur-3xl">
      {/* ****************wrapper */}
      <div className="flex w-full h-full gap-5 xxl:gap=10 ">
        ...
        <div className="relative basis-[50%]">
          ...
          <Vector_16 className="w-full h-[70px] pb-2" />
          <Vector_27 className="w-full h-[58px] absolute top-2 right-[11px]" />
        </div>
        ...
        <div className="relative basis-[50%] flex justify-end">
          ...
          {/* **************** */}
          <Vector_26 className="w-full h-[70px] pb-2" />
          <Vector_25 className="w-full h-[58px] absolute top-2 left-2" />
        </div>
      </div>
    </nav>
  );
