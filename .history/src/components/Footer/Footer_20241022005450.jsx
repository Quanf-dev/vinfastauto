...
export default function Footer() {
  return (
    <div className="relative h-[390px] bg-[#E0E7ED] px-10 pt-10 ">
      ...
      <ul className="absolute 4 flex bottom-8 gap-14 text-[0.75rem] font-medium">
        <li>© 2023 VinFast. All rights reserved.</li>
        <li>Điều khoản & Điều kiện Website</li>
        <li>Chính sách bảo mật</li>
        <li>Cài đặt Cookies</li>
      </ul>
      <ul className="absolute 4 flex right-0 bottom-8 gap-14 text-[0.75rem] font-medium">
        <li>
          <FaInstagramSquare size={2} />
        </li>
        <li>Điều khoản & Điều kiện Website</li>
        <li>Chính sách bảo mật</li>
        <li>Cài đặt Cookies</li>
